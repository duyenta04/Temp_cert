...
Feature: Hành động trên chứng từ khấu trừ thuế TNCN
  ...
  Rule: Gửi chứng từ cho người nộp thuế qua email
    ...
    @action @send-nnt
    Scenario: Gửi chứng từ đã được CQT chấp nhận cho NNT
      Given người nộp thuế có chứng từ TNCN ở trạng thái "CQT chấp nhận"
    ...
    Scenario: Yêu cầu nhập email khi chứng từ chưa có email cá nhân
      Given người nộp thuế có chứng từ TNCN ở trạng thái "CQT chấp nhận"
  ...
  Rule: Xóa chứng từ nháp
    ...
    @action @delete
    Scenario: Cho phép xóa chứng từ ở trạng thái nháp sau khi xác nhận
      Given người nộp thuế có chứng từ TNCN ở trạng thái "Nháp"
      When người nộp thuế chọn xóa chứng từ
  ...
  Rule: Thao tác hàng loạt trên danh sách
    ...
    Scenario: Gửi NNT hàng loạt
      Given người nộp thuế đang xem danh sách chứng từ TNCN
      And danh sách có nhiều chứng từ ở trạng thái "CQT chấp nhận"
