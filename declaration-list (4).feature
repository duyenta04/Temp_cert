...
Feature: Danh sách tờ khai đăng ký sử dụng chứng từ điện tử
  ...
  Rule: Ngày lập lấy từ ngày chứng từ ghi trên tờ khai

    @api @auto-fill
    Scenario: Ngày lập hiển thị đúng ngày chứng từ trên tờ khai
      Given người nộp thuế có tờ khai với ngày chứng từ xác định
      When người nộp thuế xem danh sách tờ khai
      Then cột ngày lập hiển thị đúng ngày chứng từ ghi trên tờ khai
